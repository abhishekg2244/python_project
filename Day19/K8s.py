...
class KubernetesAutomation(AutomationTool):
      def __init__(self):
      ...
      def show_menu(self):
        print("\n------ K8s MENU ------")
        print("1. kubectl namespace")
        print("2. kubectl get pod")
        print("3. kubectl get ns")
...
class DevOpsToolkit:
    def __init__(self):
        ...
        self.kubernetes=KubernetesAutomation()
    ...
    def run_kubernetes(self):
        while True:
            self.kubernetes.show_header("KUBERNESTES AUTOMATION")
            self.kubernetes.show_menu()
            ...
            try:
                ...
                elif choice in self.kubernetes.commands:
                    self.kubernetes.run_command(self.kubernetes.commands[choice])
